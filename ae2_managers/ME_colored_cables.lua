...
local COLORS = {"White", "Orange", "Magenta", "Light Blue", "Yellow", "Lime", "Pink", "Gray", "Light Gray", "Cyan",
...
function checkAndRestock()
    ...
    if targetToCraft then
        ...
        print("\n------------------------------------------------")
        print(string.format("  ==> Requesting %dx '%s' (Stock: %d%%)...", amountToOrder, spec.label,
            math.floor(targetToCraft.ratio * 100)))
